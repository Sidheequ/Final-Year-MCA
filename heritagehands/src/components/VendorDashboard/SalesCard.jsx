...
const icons = {
  ...
  revenue: (
    <svg width="20" fill="currentColor" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
      <path d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-13v2.07A4.002 4.002 0 0114 11h-2a2 2 0 10-4 0h2a2 2 0 104 0h-2a4.002 4.002 0 01-3-3.93V5a1 1 0 112 0z" />
    </svg>
  )
};
